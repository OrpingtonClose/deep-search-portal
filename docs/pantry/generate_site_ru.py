...
FOODS = [
    ...
    ("sardines", "Ferromar — мелкие сардинки", "spanish", "batch2_13.jpg",
     "Sardinillas en Aceite de Oliva — мелкие сардины в премиальном оливковом масле."),
    ("baby-eels", "Мальки угря (Angulas)", "spanish", "batch1_17.jpg",
     "Conservas de Cambados angulas в оливковом масле с перцем гиндилья."),
    ("sturgeon", "El Capricho Santoña — осётр", "spanish", "batch3_06.jpg",
     "Награждённый консервированный осётр в оливковом масле из Сантоньи."),
    ("lobster-pate", "Agromar — паштет из лобстера", "spanish", "batch3_02.jpg",
     "Paté de Bogavante — роскошные рийеты из лобстера в оливковом масле."),
    ("velvet-crab-cream", "La Venta — крем из бархатного краба", "spanish", "batch3_10.jpg",
     "Crema de Nécoras (1897) — крем из бархатного плавающего краба из Кантабрии."),

    # ── Скандинавские ──
    ("limfjord-cockles", "Fangst — сердцевидки Лимфьорда", "nordic", "batch2_01.jpg",
     "Датские сердцевидки из Лимфьорда, слегка подсоленные. Сладко-солёное совершенство."),
    ("monkfish-liver", "Fangst — печень исландского морского чёрта", "nordic", "batch2_08.jpg",
     "Havtaske Lever — слегка копчёная печень исландского морского чёрта. «Фуа-гра моря»."),
    ("cod-liver-nordic", "Fangst — печень исландской трески", "nordic", "batch3_04.jpg",
    ...
    ("pickled-fennel", "Маринованный фенхель с укропом", "nordic", "batch2_18.jpg",
     "Fennikel Syltet — фенхель скандинавского засола с укропом."),

    # ── Польские / Восточноевропейские ──
    ("catfish-bbq", "Łosoś Ustka — сом в соусе барбекю", "polish", "batch1_01.jpg",
    ...
    ("cod-liver-riga", "Riga Gold — печень трески", "polish", "batch2_02.jpg",
    ...
    ("thon-basquaise", "Jean de Luz — баскский тунец", "french", "batch2_16.jpg",
     "Thon Basquaise aux Légumes Bio — альбакор с органическими овощами и перцем Эспелет."),
    ("monkfish-fillets", "Jean de Luz — филе морского чёрта", "french", "batch2_17.jpg",
     "Filet de Lotte au Naturel — морской чёрт в слегка подсоленной родниковой воде."),
    ("pork-ratatouille", "Maison Rivière — свинина с рататуем", "french", "batch1_15.jpg",
     "Sauté de porc et sa ratatouille — классическое французское тушёное блюдо в банке."),
    ("pork-terrine", "Charcuterie Bobosse — свиной террин", "french", "batch2_10.jpg",
     "Terrine Bobossienne N°5 — ремесленный французский свиной террин."),
    ("pork-liver-pate", "Паштет из свиной печени с солью Геранд", "french", "batch3_05.jpg",
    ...
    ("baby-broad-beans", "Молодые бобы в оливковом масле", "charcuterie", "batch1_14.jpg",
     "Habitas baby en aceite de oliva — нежные испанские бобы, идеальные как тапас."),
    ("red-currant-jam", "Варенье из красной смородины", "charcuterie", "batch1_04.jpg",
     "Konfitura z czerwonych porzeczek — ручная работа, польское фруктовое варенье."),
    ("chimichurri", "Домашний соус чимичурри", "charcuterie", "batch2_04.jpg",
     "Аргентинский чимичурри — петрушка, чили, чеснок, орегано, оливковое масло, винный уксус."),
    ("tamarind-chutney", "Shan — тамариндовый чатни", "charcuterie", "batch1_18.jpg",
    ...
    ("kimchi", "Jongga — кимчи из пекинской капусты", "charcuterie", "batch3_09.jpg",
