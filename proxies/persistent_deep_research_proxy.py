...
_NAME_TO_TOOLS_MODULES: dict[str, list[str]] = {
    ...
    "tool_telegram_search": ["tools.search_tools2", "tools.tool_executor"],
    "tool_darknet_market_search": ["tools.search_tools2", "tools.tool_executor"],
    "tool_facebook_search": ["tools.search_tools2", "tools.tool_executor"],
    "tool_discord_search": ["tools.search_tools2", "tools.tool_executor"],
    "tool_signal_search": ["tools.search_tools2", "tools.tool_executor"],
    "tool_whatsapp_search": ["tools.search_tools2", "tools.tool_executor"],
    "tool_crunchbase_search": ["tools.search_tools2", "tools.tool_executor"],
    "tool_trustpilot_search": ["tools.search_tools2", "tools.tool_executor"],
    "tool_whois_lookup": ["tools.search_tools2", "tools.tool_executor"],
