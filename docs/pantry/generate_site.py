...
FOODS = [
    # ── Spanish Conservas ──
    ("bluefin-tuna", "Herpac Bluefin Tuna Loin", "spanish", "batch2_01.jpg",
     "Almadraba-caught Atlantic bluefin tuna loin in Arbequina EVOO from Barbate, Cádiz."),
    ("mackerel-roes", "Herpac Mackerel Roes", "spanish", "batch3_05.jpg",
     "Atlantic chub mackerel roe sacs in extra-virgin olive oil. Briny, creamy, delicate."),
    ("sea-urchin-roe", "Sea Urchin Roe", "spanish", "batch1_01.jpg",
    ...
    ("sardines", "Ferromar Small Sardines", "spanish", "batch2_11.jpg",
     "Sardinillas en Aceite de Oliva — small sardines in premium olive oil."),
    ("baby-eels", "Baby Eels (Angulas)", "spanish", "batch1_14.jpg",
     "Conservas de Cambados angulas in olive oil with guindilla chili."),
    ("sturgeon", "El Capricho Santoña Sturgeon", "spanish", "batch3_10.jpg",
     "Award-winning tinned sturgeon in olive oil from Santoña."),
    ("lobster-pate", "Agromar Lobster Pâté", "spanish", "batch3_03.jpg",
     "Paté de Bogavante — luxurious lobster rillettes in olive oil."),
    ("velvet-crab-cream", "La Venta Velvet Swimming Crab Cream", "spanish", "batch3_07.jpg",
     "Crema de Nécoras (1897) — velvet swimming crab cream from Cantabria."),

    # ── Nordic & Scandinavian ──
    ("limfjord-cockles", "Fangst Limfjord Cockles", "nordic", "batch2_10.jpg",
     "Danish heart cockles from the Limfjord, lightly salted. Sweet-briny perfection."),
    ("monkfish-liver", "Fangst Icelandic Monkfish Liver", "nordic", "batch2_18.jpg",
     "Havtaske Lever — lightly smoked Icelandic monkfish liver. 'Foie gras of the sea.'"),
    ("cod-liver-nordic", "Fangst Icelandic Cod Liver", "nordic", "batch3_06.jpg",
    ...
    ("pickled-fennel", "Pickled Fennel with Dill", "nordic", "batch2_15.jpg",
     "Fennikel Syltet — Scandinavian-style preserved fennel with dill."),

    # ── Polish / Eastern European ──
    ("catfish-bbq", "Łosoś Ustka Catfish in Barbecue Sauce", "polish", "batch1_03.jpg",
    ...
    ("cod-liver-riga", "Riga Gold Cod Liver", "polish", "batch2_07.jpg",
     "Wątróbki z dorsza w tłuszczu własnym — cod liver in own fat. Latvian brand, Icelandic production."),

    # ── French Products ──
    ("thon-basquaise", "Jean de Luz Basque Tuna", "french", "batch2_13.jpg",
     "Thon Basquaise aux Légumes Bio — albacore with organic vegetables and Espelette pepper."),
    ("monkfish-fillets", "Jean de Luz Monkfish Fillets", "french", "batch2_16.jpg",
     "Filet de Lotte au Naturel — monkfish in lightly salted spring water."),
    ("pork-ratatouille", "Maison Rivière Pork with Ratatouille", "french", "batch1_18.jpg",
     "Sauté de porc et sa ratatouille — classic French canned ready-meal stew."),
    ("pork-terrine", "Charcuterie Bobosse Pork Terrine", "french", "batch2_09.jpg",
     "Terrine Bobossienne N°5 — artisanal French pork terrine."),
    ("pork-liver-pate", "Pork Liver Pâté with Guérande Salt", "french", "batch3_04.jpg",
    ...
    ("baby-broad-beans", "Baby Broad Beans in Olive Oil", "charcuterie", "batch1_13.jpg",
     "Habitas baby en aceite de oliva — tender Spanish legumes, perfect as a tapa."),
    ("red-currant-jam", "Red Currant Jam", "charcuterie", "batch1_02.jpg",
     "Konfitura z czerwonych porzeczek — hand-labeled Polish fruit preserve."),
    ("chimichurri", "Artisanal Chimichurri Sauce", "charcuterie", "batch2_02.jpg",
     "Argentine-style chimichurri — parsley, chili, garlic, oregano, EVOO, wine vinegar."),
    ("tamarind-chutney", "Shan Tamarind Chutney", "charcuterie", "batch1_17.jpg",
    ...
    ("kimchi", "Jongga Napa Cabbage Kimchi", "charcuterie", "batch3_08.jpg",
